    ...
    <div class="row g-3">
        ...
        <div class="col-md-4 col-sm-6">
            ...
            <input type="text" class="form-control date_picker" id="date" name="date"
                value="{{ date('d-m-Y', strtotime($data->date)) }}" placeholder="Invest Date" required>
        </div>
        <div class="col-md-4 col-sm-6">
            <label for="invest_no" class="form-label"><b>Invest No. <span class="text-danger">*</span></b></label>
            <input type="text" class="form-control" id="invest_no" name="invest_no"
                value="{{ $data->invest_no }}" readonly placeholder="Invest No." required>
        </div>
        <div class="col-md-4 col-sm-6">
            <label for="qty" class="form-label"><b>Invest Qty <span class="text-danger">*</span></b></label>
            <input type="number" class="form-control" id="qty" name="qty" value="{{ $data->qty }}"
                placeholder="Invest Qty" required>
        </div>
        <div class="col-md-4 col-sm-6">
            <label for="amount" class="form-label"><b>Amount <span class="text-danger">*</span></b></label>
            <input type="number" class="form-control" id="amount" name="amount"
                value="{{ $data->amount }}" placeholder="Invest Amount" required>
        </div>
        <div class="col-md-4 col-sm-6">
