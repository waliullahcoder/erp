    ...
    <div class="row g-3">
        <div class="col-lg-4 col-sm-6">
            ...
            <select name="debit_head" id="debit_head" class="chosen-select" data-placeholder="select Account Name" required>
                ...
                @foreach ($debitCoas as $item)
                    <option value="{{ $item->id }}" {{ $debitEntry->coa_setup_id == $item->id ? 'selected' : '' }}>
        ...
        <div class="col-lg-4 col-sm-6">
            ...
            <input type="text" class="form-control" name="voucher_no" id="voucher_no"
                value="{{ $debitEntry->voucher_no }}" readonly required>
        </div>
        <div class="col-lg-4 col-sm-6">
            ...
            <input type="text" class="form-control date_picker" name="voucher_date" id="voucher_date"
                value="{{ date('d-m-Y', strtotime(old('voucher_date') ?? $debitEntry->voucher_date)) }}"
        ...
        <div class="col-lg-4 col-sm-6">
            ...
            <textarea class="form-control narration" id="narration" name="narration" rows="1" spellcheck="false"
                placeholder="Remarks">{{ $debitEntry->narration }}</textarea>
        </div>
        <div class="col-lg-4 col-sm-6">
