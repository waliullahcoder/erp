                ...
                @for ($i = 0; $i < $item->qty; $i++)
                    <div class="barcode-label">
                        <div class="text-center">
                            @php
                                $getresult = substr(@$item->product->code, 0);
                                $barcode = new DNS1D();
                            @endphp
