...
@section('content')
    <div class="row g-3">
        ...
        <div class="{{ $data->payment_type == 'cash' ? 'col-md-2' : 'col-md-4' }} col-sm-6" id="payment_type_area">
        ...
        @endif
        <div class="{{ $data->payment_type == 'cash' ? 'col-md-3' : 'col-md-4' }} col-sm-6" id="lifting_no_area">
            <label for="lifting_no" class="form-label"><b>Purchase No. <span class="text-danger">*</span></b></label>
            <input type="text" class="form-control" id="lifting_no" name="lifting_no" value="{{ $data->lifting_no }}"
        ...
        <div class="col-md-4 col-sm-6" id="lifting_date_area">
            ...
            <input type="text" class="form-control date_picker" id="lifting_date" name="lifting_date"
                value="{{ old('lifting_date') ? date('d-m-Y', strtotime(old('lifting_date'))) : date('d-m-Y', strtotime($data->lifting_date)) }}"
        ...
        <div class="col-md-4 col-sm-6">
            ...
            <input type="text" class="form-control" id="voucher_no" name="voucher_no" value="{{ $data->voucher_no }}"
                    ...
                    <tbody id="tbody">
                        @foreach ($lifting_products as $key => $product)
                            <tr id="product{{ $product->product_id }}">
                                <td class="text-nowrap" width="150">{{ $product->product->category->name }}</td>
                                <td>
                                ...
                                <td><input style="width: 150px;" class="text-center rate"
                                        data-id="{{ $product->product_id }}" type="number"
                                        id="lifting_price_{{ $product->product_id }}"
                                        name="lifting_price[{{ $product->product_id }}]" step="any"
                                        value="{{ $product->lifting_price }}" required></td>
                                <td><input style="width: 150px;" class="text-center qty"
                                        data-id="{{ $product->product_id }}" type="number"
                                        id="quantity_{{ $product->product_id }}"
                                        name="quantity[{{ $product->product_id }}]" step="any"
                                        value="{{ $product->qty }}" required></td>
                                <td><input style="width: 150px;" class="text-center amount"
                                        data-id="{{ $product->product_id }}" type="number"
                                        id="amount_{{ $product->product_id }}" name="amount[{{ $product->product_id }}]"
                                        step="any" value="{{ $product->total_amount }}" required></td>
                            ...
                            <td colspan="3">
                                ...
                                <div class="input-group flex-nowrap align-items-center">
                                    ...
                                    <input type="number" id="net_payable" name="net_payable" readonly
                                        ...
                                        value="{{ $data->total_cost - $data->discount }}">
                                    <span class="text-end" style="width: 25px;">TK.</span>
                                </div>
                            </td>
                        </tr>
