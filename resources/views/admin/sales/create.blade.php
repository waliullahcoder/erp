...
@section('content')
    <div class="row g-3">
        ...
        <div class="col-lg-2 col-md-4 col-sm-6" id="accounts_area" style="display: none;">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6" id="date_area">
            ...
            <input type="text" class="form-control date_picker" id="date" name="date"
                value="{{ old('date') ? date('d-m-Y', strtotime(old('date'))) : date('d-m-Y') }}" placeholder="Invoice Date"
                required>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6">
