...
@section('content')
    <div class="row g-3">
        ...
        <div class="{{ Auth::user()->hasRole('Software Admin') ? 'col-lg-3' : 'col-lg-4' }} col-sm-6">
            <label for="group_id" class="form-label"><b>Group Name <span class="text-danger">*</span></b></label>
                    ...
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input target_type" name="target_type" value="both"
                                checked><span class="ms-1">Both</span>
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input target_type" name="target_type"
                                value="amount"><span class="ms-1">Amount</span>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <table class="table table-bordered align-middle target-table" id="targetByQty">
                <thead class="bg-primary text-white">
                    <th>Category</th>
                    <th class="target_qty">Target Quantity</th>
                    <th>Target Amount</th>
                </thead>
                <tbody>
                    @foreach ($categories as $key => $category)
                        <tr>
                            ...
                            <td class="target_qty">
                                <input type="number" class="form-control target" name="target[]" value="0"
                                    oninput="countTarget()">
                            </td>
                            <td>
                                <input type="number" class="form-control targetAmt" name="target_amount[]" value="0"
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="target_qty">
                            <input type="number" class="form-control" id="totalTarget" name="total_target" value="0"
                                readonly>
                        </td>
                        <td>
