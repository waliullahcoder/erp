...
@section('content')
    <table class="table mb-2 header-table" style="border-bottom: 1px solid #ddd;">
        <tr>
            ...
            <td class="text-right">
                <b class="d-inline-block text-left">Client Name :</b>
                <span class="d-inline-block" style="min-width: 130px;">{{ @$data->client->name }}</span>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table class="table table-bordered table-condensed table-striped align-middle mb-3">
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right" colspan="1"><b>{{ number_format($data->list->sum('qty'), 2, '.', ',') }}</b></td>
