    ...
    <div class="row g-3">
        <div class="col-12">
            <div class="header-wrapper">
                <form action="{{ Route('investor.change-images', $admin->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="profile-header">
                        ...
                        <img class="lazyload img-fit absolute-full"
                            data-src="{{ $admin->cover_image ? asset($admin->cover_image) : asset('backend/images/avatar/default/cover.jpg') }}"
                            alt="Cover Image">
                    ...
                    <div class="profile-meta w-fit mx-auto">
                        <img class="user-img img-fit lazyload"
                            data-src="{{ $admin->image ? asset($admin->image) : asset('backend/images/avatar/default/user.jpg') }}"
                            alt="vendor image">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-info-edit" role="tabpanel" aria-labelledby="nav-info-edit-tab">
                        <div class="bg-white rounded-3 p-sm-4 p-3">
                            ...
                            <form action="{{ Route('investor.profile.update', $admin->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row g-3">
                    ...
                    <div class="tab-pane fade" id="nav-password-edit" role="tabpanel"
                        ...
                        <div class="bg-white rounded-3 p-sm-4 p-3">
                            ...
                            <form action="{{ Route('investor.change-password', $admin->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row g-3">
                                    <div class="col-md-4 col-xs-6">
