...
<form action="{{ route('admin.quotation.update',$quotation->id) }}" method="POST">
    @csrf
    @method('PUT')
...
<div class="card-body">
    <div class="row g-3">
         ...
         <div class="col-md-2 col-sm-6" id="quotation_area">
            <label for="quotation" class="form-label"><b>Quotation No. <span class="text-danger">*</span></b></label>
           <input type="text"
       class="form-control"
       id="quotation"
       name="quotation"
       ...
       readonly>
        ...
        <div class="col-md-3 col-sm-6">
            ...
            <select id="company_id" class="select form-select" name="company_id" data-placeholder="Select Company">
               @foreach ($companies as $company)
                <option value="{{ $company->id }}"
                    {{ $quotation->company_id == $company->id ? 'selected' : '' }}>
                    {{ $company->name }} - {{ $company->phone }}
                </option>
                @endforeach
            </select>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6" id="date_area">
            <label for="date" class="form-label"><b>Quotation Date <span class="text-danger">*</span></b></label>
           <input type="text"
       ...
       value="{{ date('d-m-Y',strtotime($quotation->date)) }}">
        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
            ...
            <select name="store_id" id="store_id" class="select form-select" data-placeholder="Select Store" required>
                ...
                <option value="{{ $store->id }}"
                    {{ $quotation->store_id == $store->id ? 'selected' : '' }}>
                    {{ $store->name }}
                </option>
                @endforeach
            </select>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
            ...
            <select name="staff_id" id="staff_id" class="select form-select" data-placeholder="Select Staff" required>
                ...
                <option value="{{ $staff->id }}"
                    {{ $quotation->staff_id == $staff->id ? 'selected' : '' }}>
                    {{ $staff->name }}
                </option>
                @endforeach
            </select>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <label for="created_by" class="form-label"><b>Quotation By <span class="text-danger">*</span></b></label>
            <input type="text" class="form-control" placeholder="Quotation By" value="{{ Auth::user()->name }}" readonly
                required>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6">
                        ...
                        <tr id="product{{ $item->product_id }}">
                            ...
                            <td>
                                <input type="number"
                                    ...
                                    name="amount[{{ $item->product_id }}]"
                                    value="{{ $item->amount }}">
                            </td>

                            <td class="text-center">
                                <button type="button"
                                        class="btn btn-outline-danger btn-sm remove_item">
                            ...
                            <td colspan="3">
                                ...
                                <div class="input-group flex-nowrap align-items-center">
                                    ...
                                    <input type="number" id="discount" name="discount" class="form-control"
                                        placeholder="Discount" style="min-width: 100px;" value="{{ $quotation->discount }}">
                                    <span class="text-end" style="width: 25px;">TK.</span>
                                </div>
                                <div class="input-group flex-nowrap align-items-center">
                                    ...
                                    <input type="number" id="net_amount" name="net_amount" readonly
                                        ...
                                        value="{{ $quotation->total_amount-$quotation->discount }}">
                                    <span class="text-end" style="width: 25px;">TK.</span>
                                </div>
                            </td>
                        </tr>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change', '#client_id', function(e) {
                ...
                let url = "{{ Route('admin.quotation.create') }}";
                $.ajax({
                    url: url,
                    type: "POST",
                    data: {
