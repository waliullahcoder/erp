...
<div class="card-body">
    <div class="row g-3">
         ...
         <div class="col-md-2 col-sm-6" id="quotation_area">
            ...
            <input type="text" class="form-control" id="quotation" name="quotation" value="{{ $quotation }}" readonly
                placeholder="Quotation No." required>
        </div>
        <div class="col-md-3 col-sm-6">
            ...
            <select id="company_id" class="select form-select" name="company_id" data-placeholder="Select Company">
                @foreach ($companies as $company)
                    <option value="{{ $company->id }}">{{ $company->name }} - {{ $company->phone }}</option>
                @endforeach
            </select>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6" id="date_area">
            ...
            <input type="text" class="form-control date_picker" id="date" name="date"
                value="{{ old('date') ? date('d-m-Y', strtotime(old('date'))) : date('d-m-Y') }}" placeholder="Quotation Date"
                required>
        </div>
