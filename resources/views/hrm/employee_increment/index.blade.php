...
<div class="card">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        @can('admin.employee-increment.create')
        <a href="{{ route('admin.employee-increment.create') }}" class="btn btn-primary">
...
$('.dataTable').DataTable({
    ...
    ajax: "{{ route('admin.employee-increment.index') }}",
    ...
    {data:'increment_type',name:'eb.increment_type'},
