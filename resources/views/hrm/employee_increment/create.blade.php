...
<div class="card">
    ...
    <form action="{{ route('admin.employee-increment.store') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label">Increment Type <span class="text-danger">*</span></label>
        ...
        <div class="card-footer text-end">
            ...
            <button type="submit" class="btn btn-success">
                <i class="fas fa-save"></i> Save increment
            </button>
