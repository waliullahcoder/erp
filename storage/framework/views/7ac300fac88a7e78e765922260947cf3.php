<?php $__env->startSection('content'); ?>
    <div class="row g-3">
        ...
        <div class="col-md-4 col-sm-6" id="lifting_no_area">
            ...
            <input type="text" class="form-control" id="lifting_no" name="lifting_no" value="<?php echo e($lifting_no); ?>"
        ...
        <div class="col-md-4 col-sm-6" id="lifting_date_area">
            ...
            <input type="text" class="form-control date_picker" id="lifting_date" name="lifting_date"
                value="<?php echo e(old('lifting_date') ? date('d-m-Y', strtotime(old('lifting_date'))) : date('d-m-Y')); ?>"
        ...
        <div class="col-md-4 col-sm-6">
            ...
            <input type="text" class="form-control" id="voucher_no" name="voucher_no" value="<?php echo e(old('voucher_no')); ?>"
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#add_item', function(e) {
                ...
                if (product_id == '' || quantity == '') {
                    ...
                    let url = "<?php echo e(Route('admin.lifting.create')); ?>";
                    $.ajax({
                        url: url,
                        type: "POST",
                        data: {
            ...
            $(document).on('change', '#payment_type', function(e) {
                if ($(this).val() == 'cash') {
                    <?php if(@$admin_setting->accounting == 1): ?>
...
<?php echo $__env->make('layouts.admin.create_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\erp\resources\views/admin/lifting/create.blade.php ENDPATH**/ ?>