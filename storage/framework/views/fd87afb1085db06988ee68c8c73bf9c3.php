...
<head>
    ...
    <title><?php echo e(!is_null($setting) ? $setting->title : ''); ?></title>
    <link rel="shortcut icon"
        href="<?php echo e(!is_null($setting) && file_exists($setting->favicon) ? asset($setting->favicon) : asset('frontend/assets/images/logo/favicon.png')); ?>"
        type="image/x-icon">
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title><?php echo e(!is_null($setting) ? $setting->title : ''); ?> Login</title>
...
<h1><i class="fa-solid fa-cubes"></i> <?php echo e(!is_null($setting) ? $setting->title : ''); ?></h1>
...
<?php /**PATH E:\laragon\www\erp\resources\views/layouts/frontend/app.blade.php ENDPATH**/ ?>